...
const getDashboardStats = async (req, res, next) => {
  try {
    ...
    const [
      ...
      Order.countDocuments({ ...currentIntervalQuery, status: { $in: ['Processing', 'Shipped'] } }),
      Order.countDocuments({ ...previousIntervalQuery, status: { $in: ['Processing', 'Shipped'] } }),
      Order.countDocuments({ ...currentIntervalQuery, status: 'Delivered' }),
